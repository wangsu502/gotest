...
type ListRacesRequest struct {
	...
	// Order specification for results (per AIP-132).
	// Format: "<field> [ASC|DESC]"
	//
	// Supported fields:
	//
	//	advertised_start_time, id, meeting_id, name, number, visible
	//
	// Supported directions: ASC (default), DESC.
	// When empty, defaults to "advertised_start_time ASC".
...
type ListRacesRequestFilter struct {
	...
	// When true, only visible races are returned.
	// When false or unset, all races are returned regardless of visibility.
...
type Race struct {
	...
	// "OPEN" if advertised_start_time is in the future, "CLOSED" otherwise.
...
var file_racing_racing_proto_rawDesc = []byte{
	...
	0x22, 0x72, 0x0a, 0x16, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x61, 0x63, 0x65, 0x73, 0x52, 0x65, 0x71,
	...
	0x0a, 0x6d, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x49, 0x64, 0x73, 0x12, 0x26, 0x0a, 0x0c, 0x76,
	0x69, 0x73, 0x69, 0x62, 0x6c, 0x65, 0x5f, 0x6f, 0x6e, 0x6c, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x08, 0x48, 0x00, 0x52, 0x0b, 0x76, 0x69, 0x73, 0x69, 0x62, 0x6c, 0x65, 0x4f, 0x6e, 0x6c, 0x79,
	0x88, 0x01, 0x01, 0x42, 0x0f, 0x0a, 0x0d, 0x5f, 0x76, 0x69, 0x73, 0x69, 0x62, 0x6c, 0x65, 0x5f,
	0x6f, 0x6e, 0x6c, 0x79, 0x22, 0xe3, 0x01, 0x0a, 0x04, 0x52, 0x61, 0x63, 0x65, 0x12, 0x0e, 0x0a,
...
var file_racing_racing_proto_depIdxs = []int32{
	...
	0, // 4: racing.Racing.GetRace:input_type -> racing.GetRaceRequest
